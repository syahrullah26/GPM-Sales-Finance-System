<?php
include 'includes/koneksi.php'; // pastikan file ini memang mengatur $konek
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-2">
                                            ...
                                            <span class="text-muted">: Tombol untuk Mengubah atau mengedit  Invoice & Surat Jalan.</span>
                                        </li>
                                        <li class="mb-2">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <?php if ($first): ?>
                                                        <td rowspan="<?= $rowspan ?>" class="table-success fw-bold text-end"><?= number_format($total_beli, 0, ',', '.') ?></td>
                                                        <td rowspan="<?= $rowspan ?>" class="table-success fw-bold text-end"><?= number_format($total_jual, 0, ',', '.') ?></td>
                                                        <td rowspan="<?= $rowspan ?>" class="table-success fw-bold text-end"><?= number_format($total_laba, 0, ',', '.') ?></td>
