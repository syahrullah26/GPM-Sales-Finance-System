...
<body>
    <a class="btn btn-primary" href='penawaran_print.php?id=<?= $data['id'] ?>'><i class="fas fa-print"></i>
        print</a>
    <a class='btn btn-success' href="penawaran_export_excel.php?id=<?= $data['id'] ?>" class="btn btn-success" target="_blank">
